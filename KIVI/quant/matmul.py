...
def qbmm_kernel(
	...
	# zero_shifter = (offs_bn % feat_per_int) * biuts
	...
	for pid_k in range(0, num_pid_k):
		...
		# tl.device_print("a: ", a.shape) # (32, 64)
		#tl.device_print("b: ", b.shape) # (32, 64)
		# tl.device_print("scales: ", scales.shape)
		# tl.device_print("zeros: ", zeros.shape)
