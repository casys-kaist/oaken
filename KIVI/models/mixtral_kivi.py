...
# TODO @longjie no longer copied from Mistral after static cache
class MixtralAttention_KIVI(nn.Module):
    """
...
# TODO @longjie no longer copied from Mistral after static cache
class MixtralFlashAttention2(MixtralAttention_KIVI):
    """
...
# TODO @longjie no longer copied from Mistral after static cache
class MixtralSdpaAttention(MixtralAttention_KIVI):
    """
...
class MixtralForCausalLM_KIVI(MixtralPreTrainedModel, GenerationMixin):
