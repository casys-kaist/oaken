    ...
    def forward(
        ...
        **kwargs,
        ...
        if past_key_value is not None:
            ...
            # Calculate attn_output
            value_states_full_length = value_states_full.shape[-1]
            value_states_full_repeat = repeat_kv(value_states_full, self.num_key_value_groups)
            if value_states_quant is None:
                ...
                attn_output = triton_bmm_fA_qB_outer(self.group_size, attn_weights[:, :, :, :-value_states_full_length], value_states_quant_repeat,
...
class MistralDecoderLayer_KIVI_eval(nn.Module):
    def __init__(self, config: MistralConfig):
        ...
        self.self_attn = (
            ...
            else MistralFlashAttention_KIVI_eval(config)
        )
