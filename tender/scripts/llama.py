    ...
    if args.scale_factor:
        ...
        for layer in model.model.layers:
            ...
            if args.quant_mha:
                ...
                print(f"q_tmax: {attn.q_tmax.shape}, q_cmax: {attn.q_group_index.shape}, s_tmax: {attn.s_tmax.shape}, s_cmax: {attn.s_group_index.shape}. k_scale: {attn.k_scale.shape}, v_scale: {attn.v_scale.shape}")
