...
class MistralAttention_Tender_Eval(nn.Module):
    """
...
class MistralFlashAttention2(MistralAttention_Tender_Eval):
    """
...
class MistralDecoderLayer(nn.Module):
    def __init__(self, config: MistralConfig, layer_idx):
        ...
        self.hidden_size = config.hidden_size
        self.self_attn = (
            MistralAttention_Tender_Eval(config=config, layer_idx=layer_idx)
        )
